...
export default class Table {
    constructor(parameters) {
        ...
        material = new THREE.LineDashedMaterial({dashSize: parameters.size.y/(2.0 * parameters.dashes-1.0), gapSize: parameters.size.y/(2.0 * parameters.dashes-1.0),  color: parameters.color });
